            ...
            @csrf
                <div class="form-row align-items-center mb-3">
                    ...
                    <div class="form-group col-9 mb-0">
                        <input type="text" id="item_name" name="item_name" class="form-control  @error('item_name') is-invalid @enderror" value="{{ old('item_name') }}" placeholder="Item Name" required autofocus>
                        @error('item_name')
                ...
                <div class="form-row align-items-center mb-3">
                    ...
                    <div class="form-group col-9 mb-0">
                        <input type="text" id="price" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}" placeholder="Price" required>
                        @error('price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
